...
function ProfilePage() {
  ...
  return (
    ...
    >
      ...
      <Grid container spacing={2} md={6} xs={12} xsOffset={0} alignItems='left'>
        ...
        <Grid container xs={12} justity='left' alignItems='left'>
          <Grid xs={6}>
            <Card>
              <CardContent>
                <Typography textAlign='left'>Tipo de Documento:</Typography>
              </CardContent>
            </Card>
          </Grid>
          <Grid xs={6}>
        ...
        <Grid container xs={12} justity='left' alignItems='left'>
          ...
          <Grid xs={6}>
            <Card>
              <CardContent>
                <Typography textAlign='left'>{identity.username}</Typography>
              </CardContent>
            </Card>
          </Grid>
        </Grid>
        ...
        <Grid container xs={12} justity='left' alignItems='left'>
          <Grid xs={6}>
            <Card>
              <CardContent>
                <Typography textAlign='left'>Número de documento</Typography>
              </CardContent>
            </Card>
          </Grid>
          <Grid xs={6}>
